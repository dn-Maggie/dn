		...
		<form id="queryForm"><!-- 查询区 表单 -->
			<div class="search border-bottom">
				...
				<li class="date_area">
					...
					<li>
						<select class="search_choose" name="subjectId" id="subjectId" mainid="subjectId">
				...
				<li>
					<select class="search_choose" name="createdby" id="createdby" mainid="createdby" onchange="enterChange(this.value);">
						<option value="">-请选择-</option>
						<c:forEach var="useradmin" items="${useradmin}">
							<option value="${useradmin.id}"> <c:out value="${useradmin.fullName}"></c:out> </option>
			            </c:forEach>
					</select><span>管理员:</span>
				</li>
				<li>
					<select class="search_choose" name="userId" id="userId" mainid="userId" >
						<option value="">-请选择-</option>
						<c:forEach var="user" items="${user}">
							<option value="${user.id}"> <c:out value="${user.fullName}"></c:out> </option>
			            </c:forEach>
		...
		<div class="listplace">
				...
				<div class="list_btn_bg fl"><!--功能按钮 div-->
					<ul>
						...
						<li><a title="跟踪" href="javascript:"
							onclick="genzong();"> <i class="icon_bg icon_ckxq"></i> <span>跟踪</span>
						</a></li>
