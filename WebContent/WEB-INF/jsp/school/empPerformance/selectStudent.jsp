...
<body>
	<div style="height: 100%;">
		<div id="tabs_top" style="height:100%;border:1px solid #cccccc;border-top:0px solid #cccccc;border-left:0px solid #cccccc;">
	    <ul>
		    ...
		    <div id="tabs-2" style="height:96%;padding:0px;">
				...
				<form id="queryForm1"><!-- 查询区 表单 -->
					<div class="search border-bottom">
						<ul>
						<li>
							<input type="text" name="stuName" id="stuName" class="search_choose"> <span>学生姓名:</span>
							<input type="hidden" name="isCount" id="isCount" value="未分配业绩"/>
						</li><!-- 输入框-->
						<li class="date_area">
							<span>日期:</span>
							<div class="time_bg">
						...
						<li><input type="reset" class="reset_btn" onclick="resetForm('queryForm')" value="重置"><!-- 重置 -->
								<input type="button" class="search_btn mr22 " onclick="doSearchForm1();" value="查询"></li><!-- 查询-->
						</ul>
				   </div>
			   	 </form>
					<div class="listplace">
							...
							<div style="text-align:center;">
								<input type="button" class="ti_bottom" value="确定" onclick="drawForm1();"/>
								<input type="button" class="ti_bottom"  onclick="window.parent.closeSelectStudent();" value="取消"/>
							</div>
							</div>
					</div>
				</div>
			...
			<div id="tabs-3" style="height:96%;padding:0px;">
		        <div class="main  choice_box">
					<form id="queryForm2"><!-- 查询区 表单 -->
						<div class="search border-bottom">
							<ul>
							<li>
								<input type="text" name="stuName" id="stuName" class="search_choose"> <span>学员姓名:</span>
								<input type="hidden" name="isCount" id="isCount" value="未分配业绩"/>
							</li><!-- 输入框-->
							...
							<li><input type="reset" class="reset_btn" onclick="resetForm('queryForm')" value="重置"><!-- 重置 -->
									<input type="button" class="search_btn mr22 " onclick="doSearchForm2();" value="查询"></li><!-- 查询-->
							</ul>
					   </div>
				    </form>
					<div class="listplace">
							...
							<div style="text-align:center;">
								<input type="button" class="ti_bottom" value="确定" onclick="drawForm2();"/>
								<input type="button" class="ti_bottom"  onclick="window.parent.closeSelectStudent();" value="取消"/>
							</div>
							</div>
					</div>
