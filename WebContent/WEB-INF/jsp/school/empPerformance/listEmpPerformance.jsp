	...
	<div class="main  choice_box">
				...
				<select class="search_choose" name="position" id="position" >
					<option value="">--请选择--</option>
						<c:forEach var="followers" items="${followers}">
							<option value="${followers.position}"> <c:out value="${followers.position}"></c:out> </option>
			             </c:forEach>
					</select><span>参与岗位:</span>
				</li>
				<li class="date_area">
					<span>发生时间:</span>
					<div class="time_bg">
		...
		<div class="listplace">
				...
				<div class="list_btn_bg fl"><!--功能按钮 div-->
					<ul>
						<c:if test="${add}">
							<!-- <li><a title="在原分配基础上增补新转化人" href="javascript:;"
								onclick="addEmp();"> <i class="icon_bg icon_add"> </i> <span>员工补录</span>
							</a></li> -->
						
							<li><a title="分配补款退款的业绩转化人" href="javascript:;"
								onclick="add();"> <i class="icon_bg icon_add"></i> <span>补款退款</span>
							</a></li>
						</c:if>
						<c:if test="${edit}">
							<li><a title="编辑学生信息" href="javascript:;"
								onclick="edit();"><i class="icon_bg icon_edit"></i> <span>编辑</span> </a></li>
						</c:if>
...
<script type="text/javascript">
	...
	var show_iframe_dialog;
  	...
  	function add(){
  	//xin zeng iframe 弹出框
		var url="<m:url value='/empPerformance/toAddEmpPerformance.do'/>";
