...
<body style="height:100%;">
	<iframe id="iframeAdd" name="iframeAdd" src="<%=request.getContextPath() %>/empNotice/toAddEmpNotice.do" width="100%" frameborder="no" border="0" height="51%"></iframe>
	<div class="main  choice_box">
		<form id="queryForm"><!-- 查询区 表单 -->
			<div class="search border-bottom">
				<ul>
				<li><input type="text" name="createName" id="createName" class="search_choose"> <span>发布者:</span></li><!-- 输入框-->
				<li class="date_area">
					<span>发布日期:</span>
					<div class="time_bg">
				...
				<li><input type="text" name="noticeContent" id="noticeContent" class="search_choose"> <span>关键字:</span></li><!-- 输入框-->			
...
var gridObj = {};
	$(function(){
  		gridObj = new biz.grid({
            ...
            url: "<m:url value='/empNotice/listEmpNotice.do'/>",/*grid初始化请求数据的远程地址*/
            ...
            colModel:[
				...
				{name : "createName",label:"发布作者",index : "create_id"},			
				{name : "noticeTitle",label:"公告标题",index : "notice_title"},
				{name : "createTime",label:"发布时间",index : "create_time"},	
				{name : "editName",label:"最后修改作者",index : "edit_id"},
				{name : "editTime",label:"最后修改时间",index : "edit_time"},
           	],
	...
	//新增方法
  	function add(){
		var url="<m:url value='/empNotice/toAddEmpNotice.do'/>";
    ...
    function edit(){
		...
		var url="<m:url value='/empNotice/toEditEmpNotice.do'/>?key="+key;
    ...
    function batchDelete(){
    	...
    	if(ids==""){
    		...
    		new biz.alert({type:"confirm",message:I18N.msg_del_confirm,title:I18N.promp,callback:function(result){
    			if(result){
    				$ .ajax({
        				url: "<m:url value='/empNotice/deleteEmpNotice.do'/>?key="+ids,
        				cache:false,
