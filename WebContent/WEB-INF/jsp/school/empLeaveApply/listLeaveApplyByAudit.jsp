			...
			<form id="queryForm">
				...
				<div class="search border-bottom">
					<ul>
						...
						<li><input type="text" name="empNAME" id="empNAME" class="search_choose"> <span>员工姓名:</span></li><!-- 输入框-->
						<li class="date_area">
							<span>申请日期:</span>
							<div class="time_bg">
						...
						<li style="width:180px;">
								<select class="search_choose" name="leaveDate" id="leaveDate" style="width:100px;">
									<option value="0">所有</option>
									<option value="2">三天以上</option>
							</select><span>请假期限:</span>
						</li><!-- 输入框-->
						<li style="width:180px;">
								<select class="search_choose" name="leaveType" id="leaveType" mainid="leaveType" style="width:100px;">
									<option value="">所有</option>
									<option value="1">事假</option>
									<option value="2">公假</option>
								</select><span>请假类型:</span>
						</li><!-- 输入框-->
						<li style="width:180px;">
						...
						<ul>
							...
							<c:if test="${deptLeader||headLeader||isAdmin}">
								<li><a title="驳回审核" href="javascript:"
										onclick="cancelAudit();"> <i class="icon_bg icon_audit"></i> <span>驳回审核</span>
								</a></li>
							</c:if>
						</ul>
					</div>
