    ...
    <div class="ui-table ui-widget ui-corner-all ui-border" >
		...
		<!-- 员工基本信息 -->
			...
			<tr>
				...
				<td class="inputTd">
					<div class="time_bg">
						<input type="text" class="search_time150 valid" name="birthDate" id="edit_birthDate" mainid="birthDate"><!-- 时间选择控件-->
				...
				<td class="inputTd">
					<select style="float:none" onchange="subAreaChange(this);" class="small_input_select" name="nativePlace" id="edit_nativePlace" mainid="nativePlace">
						...
						<c:forEach var="ca" items="${area.parent}">
							<option did="${ca.id}" value="${ca.name}"> <c:out value="${ca.name}"></c:out> </option>
			             </c:forEach>
			        </select>
			...
			<tr>
				...
				<td class="inputTd">
					<select style="float:none" class="input_select" name="nation" id="edit_nation" mainid="nation">
						<c:forEach var="nation" items="${nation}">
							<option value="${nation.nationName}"> <c:out value="${nation.nationName}"></c:out> </option>
			             </c:forEach>
			        </select>	
				</td>
				...
				<td class="inputTd">
					<select style="float:none" class="input_select" name="maritalStatus" id="edit_maritalStatus" mainid="maritalStatus">
						<option value="未婚">未婚</option><option value="已婚">已婚</option><option value="离婚">离婚</option><option value="丧偶">丧偶</option>
			        </select>
				</td>
			</tr>		
			<tr>
			...
			<tr>
				...
				<td class="inputTd">
					<input id="edit_mailAddress" name="mailAddress" type="text" class="text"/>				
				</td>
		...
		<!-- 员工入职信息 -->
			...
			<tr>
				...
				<td class="inputTd">
					<select style="float:none" class="input_select" name="currState" id="edit_currState" onchange="getCurrState(this)">
				...
				<td class="inputTd">
					<input id="edit_empNo" name="empNo" type="text" class="text" value="DN-${nowEmpNo.empNo+1}"/>
				</td> 
			</tr>
			<tr>
				...
				<td class="inputTd">
					<input id="position" name="position" type="text" class="text" value="${userInfo.dutyName}" />
					<input id="dutyId" name="dutyId" type="hidden" class="text" value="${userInfo.dutyId}"/>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="inputTd">
					<input id="edit_salValue" name="salValue" type="number" class="text" max="0" value="3000"/>
				</td>
				<td class="inputLabelTd">股份配额(股)：</td>
				<td class="inputTd">
					<input id="edit_stockNum" name="stockNum" type="number" class="text" max="0"/>
				</td>
			</tr>
			<tr>
				...
				<td class="inputTd">
					<div class="time_bg">
						<input type="text" class="search_time150 valid" name="entryDate" id="edit_entryDate" ><!-- 时间选择控件-->
						<i class="search_time_ico2"></i>
					</div>
				</td>
			...
			<tr>
				...
				<td class="inputTd" colspan="3" >
					<textarea  id="edit_note" name="note"  class="text" rows="" cols=""></textarea>
				</td>
			</tr>
			...
			<tr class="addEnable">
				...
				<td class="inputTd">
					<select style="float:none" class="input_select" name="checkStanderd" id="edit_checkStanderd" mainid="checkStanderd" >
						...
						<option value="2" >客服基本工资考核</option>
						<option value="5" >助教基本工资考核</option>
						<option value="6" >班主任基本工资考核</option>
						<option value="1" >职能部门基本工资考核</option>
						<option value="3" >公开课讲师基本工资考核</option>
						<option value="4" >VIP讲师基本工资考核</option>
					</select>
				</td>
			</tr>
			<tr class="addEnable">
			...
			<tr>
				...
				<td class="inputTd" colspan="3" title="家庭成员姓名+关系+联系方式">
					<textarea id="edit_familyMember" name="familyMember"  class="text" ></textarea>
				</td>
			</tr>
			<tr>
				<td class="inputLabelTd">教育经历：</td>
				<td class="inputTd" colspan="3" title="时间+详细信息">
					<textarea id="edit_educationExperience" name="educationExperience"  class="text"></textarea>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="inputTd" colspan="3" title="时间+详细信息">
					<textarea  id="edit_workExperience" name="workExperience"  class="text" rows="" cols=""></textarea>
				</td>
			</tr>
			<tr>
