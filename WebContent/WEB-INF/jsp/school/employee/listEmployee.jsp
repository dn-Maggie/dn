	...
	<div class="main  choice_box">
		<form id="queryForm"><!-- 查询区 表单 -->
			<div class="search border-bottom">
				<ul>
				<li><input type="text" name="name" id="name" class="search_choose"> <span>员工姓名:</span></li><!-- 输入框-->
				<li>
					<select style="float:none" class="search_select" name="dept" id="edit_dept" mainid="dept" >
				...
				<li>
				<select class="search_choose" name="dutyId" id="dutyId" >
					<option value="">--请选择--</option>
						<c:forEach var="duty" items="${duty}">
							<option value="${duty.id}"> <c:out value="${duty.dutyName}"></c:out> 
							</option>
			            </c:forEach>
				</select><span>所在岗位:</span>
				</li>
				<li class="date_area">
					<span>入职时间:</span>
					<div class="time_bg">
				...
				<li class="date_area">
					<span>转正时间:</span>
					<div class="time_bg">
						<input id="beFullDateStart" type="text" class="search_time150" name="propsMap['beFullDateStart']" mainid="beFullDateStart">
						<i class="search_time_ico2"></i>
					</div>
					<i>至</i>
					<div class="time_bg">
						<input id="beFullDateEnd" type="text" class="search_time150" name="propsMap['beFullDateEnd']" mainid="beFullDateEnd">
						<i class="search_time_ico2"></i>
					</div>
				</li>	
				<li class="date_area">
					<span>离职时间:</span>
					<div class="time_bg">
						<input id="leaveDateStart" type="text" class="search_time150" name="propsMap['leaveDateStart']" mainid="leaveDateStart">
						<i class="search_time_ico2"></i>
					</div>
					<i>至</i>
					<div class="time_bg">
						<input id="leaveDateEnd" type="text" class="search_time150" name="propsMap['leaveDateEnd']" mainid="leaveDateEnd">
						<i class="search_time_ico2"></i>
					</div>
				</li>
