...
<div id="editDialog">
	<form id="empAbsenceFormEdit" >
		    <div class="wrap">
			<input type="hidden" id="edit_id" name="id" type="text" value="${empAbsence.id}"/>
			...
			<div class="top_head">
				...
				<div class="time_bg" style="top:40px; left:0px;height: 25px;line-height: 25px;position:absolute;width:220px">
					<span>申请时间：</span>
					<input id="edit_createDate" name="createDate" class="input_select" style="height: 25px;width:100px" readonly/>
			...
			<div class="center_body">
				<table class="table">
					...
					<tr class="trDetails" style="height:140px;">
						...
						<span class="required">*</span>申请原因：</td>
					...
					<tr>
						...
						<td class="inputTd">
							<div class="time_bg" style="width: 98%;">
								<input type="text" class="search_time150 valid text" name="absenceDate" id="edit_absenceDate"  style="width: 88%;" ><!-- 时间选择控件-->
								<i class="search_time_ico2"></i>
							</div>
						</td>
						<td class="inputLabelTd"><span class="required">*</span>补签类型：</td>
						<td class="inputTd">
							<select name="absenceType" id="edit_absenceType" class="input_select" >
