    ...
    <div class="ui-table ui-widget ui-corner-all ui-border" >
		...
		<table class="table">
			...
			<tr>
				...
				<td class="inputTd">
					<input id="edit_name" name="name" type="text" class="text" value="${vipStudent.name}"/>
				</td>
				<td class="inputLabelTd">年龄：</td>
				<td class="inputTd">
					<input id="edit_age" name="age" type="text" class="text" value="${vipStudent.age}"/>
				</td>
			</tr>
			<tr>
				<td class="inputLabelTd">手机号码：</td>
				<td class="inputTd">
					<input id="edit_phone" name="phone" type="text" class="text" value="${vipStudent.phone}"/>
				</td>
				<td class="inputLabelTd">QQ：</td>
				<td class="inputTd">
					<input id="edit_qq" name="qq" type="text" class="text" value="${vipStudent.qq}"/>
				</td>
			</tr>
			<tr>
				<td class="inputLabelTd">QQ昵称：</td>
				<td class="inputTd">
					<input id="edit_qqNick" name="qqNick" type="text" class="text" value="${vipStudent.qqNick}"/>
				</td>
			...
			<tr>
				...
				<td class="inputTd">
					<select onchange="$('#edit_courseName').val('');courseChange(this.value);"  style="float:left" class="input_select" name="subjectId" id="edit_subjectId" >
				...
				<td class="inputTd">
					...
					<input class="text" name="courseName" id="edit_courseName" list="courseList" value="${vipStudent.courseName}" onchange="getIdByName(this,this.value)" />	
			...
			<tr>
				...
				<td class="inputTd">
					<input id="edit_teacherId" name="teacherId" type="text" class="text" list="teacherList" value="${vipStudent.teacherId}"/>	
				...
				<td class="inputTd">
					<input id="edit_tutorId" name="tutorId" type="text" class="text" list="tutorList" value="${vipStudent.tutorId}"/>
			...
			<tr>
				<td class="inputLabelTd">目前公司：</td>
				<td class="inputTd">
					<input type="text" class="text" name="currCompany" id="edit_currCompany" />
				</td>
				<td class="inputLabelTd">目前职位：</td>
				<td class="inputTd">
					<input id="edit_currPosition" name="currPosition" type="text" class="text"/>
				</td>
			</tr>
			<tr>
				<td class="inputLabelTd">工作年限：</td>
				<td class="inputTd">
					<input type="text" class="text" name="workingYear" id="edit_workingYear" />
				</td>
				<td class="inputLabelTd">目前薪酬：</td>
				<td class="inputTd">
					<input id="edit_salary" name="salary" type="text" class="text"/>
				</td>
			</tr>	
			...
			<tr>
				...
				<td class="inputTd">
					...
					<input id="edit_shouldPay" name="shouldPay" onblur="countOwePay()" type="number" class="text" value="${vipStudent.shouldPay}"/>
				</td>
				<td class="inputLabelTd">实缴学费：</td>
				<td class="inputTd">
					<input id="edit_actualPay" onblur="countOwePay()" name="actualPay" type="number" class="text" value="${vipStudent.actualPay}" readonly/>
				</td>
			</tr>
			<tr>
				<td class="inputLabelTd">欠缴学费：</td>
				<td class="inputTd">
					<input id="edit_owePay" name="owePay" type="text" class="text" value="${vipStudent.owePay}" readonly="readonly" />
				</td>
				<td class="inputLabelTd">付款方姓名：</td>
				<td class="inputTd">
					<input id="edit_payerName" name="payerName" type="text" class="text" value="${vipStudent.payerName}"/>
				</td>
			</tr>
			<tr>
				...
				<td class="inputTd">
					<select class="input_select" name="payType" id="edit_payType" disabled="disabled"><option value="">--请选择--</option>
			...
			<tr>
				...
				<input type="hidden" id="isCount" name="isCount" value="${vipStudent.isCount}" />
				
				<input type="hidden" id="xftzNo" name="xftzNo" value="${xftz.accountNo}" />
				<input type="hidden" id="xftzId"  value="${xftz.id}" />
				<input type="hidden" id="xftzType"  value="${xftz.accountType}" />
				<input type="hidden" id="xftzName"  value="${xftz.accountName}" />
				
				<input type="hidden" id="xftjNo" name="xftjNo" value="${xftj.accountNo}" />
				<input type="hidden" id="xftjId"  value="${xftj.id}" />
				<input type="hidden" id="xftjType"  value="${xftj.accountType}" />
				<input type="hidden" id="xftjName"  value="${xftj.accountName}" />
        </div>
	</form>
...
// 			addAccountFlow();
	...
	new biz.validate({
		...
		rules:{
			...
			"actualPay" : {required : true,number:true},
		}
	}); 
});
//自动计算欠款金额
...
function updateVipStudent(){
	...
	var isGoclass = $("input:radio[name='isGoclass']:checked").val();
