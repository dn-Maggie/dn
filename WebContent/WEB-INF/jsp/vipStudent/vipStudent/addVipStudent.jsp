    ...
    <div class="ui-table ui-widget ui-corner-all ui-border">
		...
		<table class="table" id="vipStuTable">
			...
			<tr>
				...
				<td class="inputLabelTd"><span class="required">*</span>能否上课：</td>
				<td class="inputTd">
					<label class="radio"><input type="radio" name="isGoclass" id="optionsRadios1" value="1" >是</label>
					<label class="radio"><input type="radio" name="isGoclass" id="optionsRadios2" value="0" >否</label>				
				</td>
			</tr>
			...
			<tr>
				...
				<td class="inputTd">
					<select onchange="courseChange(this.value);" class="input_select" name="subjectId" id="edit_subjectId" mainid="subjectId">
			...
			<tr>
				...
				<td class="inputTd">
					<input class="text" name="teacherId" id="edit_teacherId" list="teacherList">	
				...
				<td class="inputTd">
					<input class="text" name="tutorId" id="edit_tutorId" list="tutorList">	
			...
			<tr>
				...
				<td class="inputTd">
					<div class="time_bg">
						<input type="text" class="search_time150 valid" name="joinTime" id="edit_joinTime"><!-- 时间选择控件-->
						<i class="search_time_ico2" onclick="WdatePicker({el:'edit_joinTime'})"></i>
					</div>
				</td>
			...
			<tr>
				...
				<td class="inputTd">
					<input class="text" name="payType" id="edit_payType" list="payTypeList">
				...
				<td class="inputTd">
					<input id="edit_payAccount" name="payAccount" type="text" class="text" value="${vipStudent.payAccount}"/>
				</td>
			</tr>
			<tr>
				<td class="inputLabelTd">到款账号：</td>
				<td class="inputTd">
					<input id="edit_receiveAccount" name="receiveAccount" type="text" class="text" value="${vipStudent.receiveAccount}"/>
				</td>
				<td class="inputLabelTd">交易号或流水号：</td>
				<td class="inputTd">
					<input id="edit_serialNo" name="serialNo" type="text" class="text" value="${vipStudent.serialNo}"/>
				</td>
			</tr>
			<tr>
