	...
	<div class="ui-table ui-widget ui-corner-all ui-border">
		<table class="table forview">
			...
			<tr>
				...
				<td class="inputTd">
					<label class="radio"><input type="radio" name="isGoclass" id="edit_isGoclass1" value="1"  disabled="disabled"<c:if test="${vipStudent.isGoclass=='1'}">checked</c:if>>是</label>
					<label class="radio"><input type="radio" name="isGoclass" id="edit_isGoclass2" value="2" disabled="disabled"<c:if test="${vipStudent.isGoclass=='2'}">checked</c:if>>否</label>			
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="inputTd">${vipStudent.receiveAccount}</td>
				<td class="inputLabelTd">交易号或流水号：</td>
				<td class="inputTd">${vipStudent.serialNo}</td>
			</tr>
			<tr style="text-indent: 4em"><td colspan="4"><i class="icon_bg icon_plan"></i> 学生来源信息</td></tr>
			<tr>
			...
			<tr>
				...
				<td class="inputTd">${vipStudent.comSourceName}</td>
				<td class="inputLabelTd">来源分类：</td>
				<td class="inputTd">${vipStudent.sourceSubclass}</td>
			</tr>
			<tr>
				<td class="inputTd" colspan="4" style="text-align:center;">
					<input class="ti_bottom"  type="button" id="close_button"  onclick="window.parent.closeShow();" value="关闭"/>
				</td>
			</tr>
		</table>
	</div>
