    ...
    <div class="wrap">
		...
		<div class="top_head">
			...
			<div class="time_bg" style="top:40px; right:0px;height: 25px;line-height: 25px;position:absolute;width:200px">
				<span>申请日期：</span>
				<input id="enterDate" type="text" class="search_time150" name="enterDate" mainid="enterDate" style="height: 25px;">
				<i class="search_time_ico2"  onclick="WdatePicker({el:'enterDate'})" style="top:6px;"></i>
			</div> 
		</div>
		<div class="center_body">
			<table class="table">
				<tr>
					...
					<td class="inputTd">
						<input id="edit_deptNo" name="deptNo" type="hidden"/>
						<input id="edit_deptName" name="deptName" type="text" class="text"  list="orgList" value="${employee.dept}" onchange="getOrgIDByName(this,this.value);"/>
						<datalist id="orgList">
					...
					<td class="inputTd">
						<input id="edit_enterPid" name="enterPid" type="hidden" value="${employee.id}"/>
						<input id="edit_enterName" name="enterName" type="text" class="text"  list="empList" value="${employee.name}" onchange="getEmpIDByName(this,this.value);"/>
						<datalist id="empList">
				...
				<tr>
					...
					<td class="inputTd" >
						<input id="edit_expenseMoney" name="expenseMoney" type="text" class="text" value="${expenseAccount.expenseMoney}"/>
