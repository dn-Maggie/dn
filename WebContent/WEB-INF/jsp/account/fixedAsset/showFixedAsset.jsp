    ...
    <div class="wrap" >
		...
		<table class="table">
			...
			<tr>
				...
				<td class="inputTd">
					<label id="edit_assetNo">${fixedAsset.assetNo}</label>
				</td>
				<td class="inputLabelTd">会计期间：</td>
				<td class="inputTd">
					<label id="edit_enterDate">${fixedAsset.enterDate}</label>
					<input name="enterDate" id="enterDate" type="hidden" class="text" value="${fixedAsset.enterDate}"/>
				</td>
				<td class="inputLabelTd">增加方式：</td>
				<td class="inputTd">
					<label id="edit_addType">${fixedAsset.addType}</label>
				</td>
			</tr>
			<tr>
				<td class="inputLabelTd"><span class="required">*</span>资产名称：</td>
				<td class="inputTd">
					<label id="edit_assetName">${fixedAsset.assetName}</label>
				</td>
				<td class="inputLabelTd"><span class="required">*</span>资产项目名称：</td>
				<td class="inputTd">
					<label id="edit_assetType">${fixedAsset.assetItemId}</label>
				</td>
				<td class="inputLabelTd">规格型号：</td>
				<td class="inputTd">
					<label id="edit_model">${fixedAsset.model}</label>
				</td>
			</tr>
			<tr>
				<td class="inputLabelTd"><span class="required">*</span>开始使用日期：</td>
				<td class="inputTd">
					<label id="edit_beginDate">${fixedAsset.beginDate}</label>
				</td>
				<td class="inputLabelTd"><span class="required">*</span>使用部门：</td>
				<td class="inputTd">
				    <label id="edit_useOrg">${fixedAsset.useOrg}</label>
				</td>
				<td class="inputLabelTd">使用人：</td>
				<td class="inputTd">
					<label id="edit_workNumber">${fixedAsset.workNumber}</label>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="inputTd">
					<label id="edit_ljzjSubject">累计折旧</label>
				</td>
				<td class="inputLabelTd"><span class="required">*</span>折旧费用科目：</td>
				<td class="inputTd">
					<label id="edit_zjfySubject">${fixedAsset.zjfySubject}</label>
				</td>
				<td class="inputLabelTd"><span class="required">*</span>资产清理科目：</td>
				<td class="inputTd">
					<label id="edit_zichanClear">固定资产清理</label>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="inputTd">
					<label id="edit_initialValue">${fixedAsset.initialValue}</label>
				</td>
				<td class="inputLabelTd"><span class="required">*</span>残值率：</td>
				<td class="inputTd">
					<label id="edit_remainRatio">${fixedAsset.remainRatio}</label>&nbsp;%
				</td>
				<td class="inputLabelTd">预计残值：</td>
				<td class="inputTd">
					<label id="edit_remainValue" name="remainValue">${fixedAsset.remainValue}</label>
				</td>
			</tr>
			<tr>
				<td class="inputLabelTd"><span class="required">*</span>预计使用月份：</td>
				<td class="inputTd">
					<label id="edit_usePeriod" name="usePeriod">${fixedAsset.usePeriod}</label>
				</td>
				<td class="inputLabelTd"><span class="required">*</span>已折旧月份：</td>
				<td class="inputTd">
					<label id="edit_depredMonth" name="depredMonth">${fixedAsset.depredMonth}</label>
				</td>
				<td class="inputLabelTd">剩余使用月份：</td>
				<td class="inputTd">
					<label id="edit_remainUseMonth" name="remainUseMonth" >${fixedAsset.remainUseMonth}</label>
				</td>
			</tr>
			<tr>
				<td class="inputLabelTd"><span class="required">*</span>累计折旧：</td>
				<td class="inputTd">
					<label id="edit_usedDepre" name="usedDepre">${fixedAsset.usedDepre}</label>
				</td>
				<td class="inputLabelTd"><span class="required">*</span>每月折旧额：</td>
				<td class="inputTd">
					<label id="edit_perDepred" name="perDepred">${fixedAsset.perDepred}</label>
				</td>
			...
			<tr>
				<td class="inputTd" colspan="6" style="text-align:center;">
					 <input id="reset" type="button" class="ti_bottom" value="关闭" onclick="window.parent.closeShow();"/> 
				</td>
			</tr>
		</table>
    </div>
