    ...
    <div class="wrap" >
		...
		<table class="table">
			...
			<tr>
				...
				<td class="inputTd">
					<div class="time_bg">
						<input type="text" class="valid text" name="beginDate" id="edit_beginDate" mainid="beginDate"><!-- 时间选择控件-->
			...
			<tr>
				...
				<td class="inputTd">
					<input id="edit_zjfySubject" name="zjfySubject" type="text" class="text" value="管理费用-折旧费" onclick="chooseZJSub(this)" onblur="hideZjSubjectList()"/>
			...
			<tr>
				...
				<td class="inputTd">
					<input id="edit_initialValue" name="initialValue" type="text" class="text" value="0" onblur="countYJCZ();countPerDepre();"/>
				</td>
				...
				<td class="inputTd">
					<input id="edit_remainValue" name="remainValue" type="text" class="text" style="background: #eeeeee" value="0" readonly/>
				</td>
			</tr>
			<tr>
				<td class="inputLabelTd"><span class="required">*</span>预计使用月份：</td>
				<td class="inputTd">
					<input id="edit_usePeriod" name="usePeriod" type="text" class="text" value="0" onblur="countRemainMonth();countPerDepre();"/>
				</td>
				<td class="inputLabelTd"><span class="required">*</span>已折旧月份：</td>
				<td class="inputTd">
					<input id="edit_depredMonth" name="depredMonth" type="text" class="text" value="0" onblur="countRemainMonth();countPerDepre();"/>
				</td>
				<td class="inputLabelTd">剩余使用月份：</td>
				<td class="inputTd">
					<input id="edit_remainUseMonth" name="remainUseMonth" type="text" class="text" value="0" style="background: #eeeeee" readonly/>
				</td>
			</tr>
			<tr>
				<td class="inputLabelTd"><span class="required">*</span>累计折旧：</td>
				<td class="inputTd">
					<input id="edit_usedDepre" name="usedDepre" type="text" class="text" value="0" onblur="countPerDepre();"/>
				</td>
