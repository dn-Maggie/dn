		...
		<form id="queryForm"><!-- 查询区 表单 -->
			<div class="search border-bottom">
				<ul>
					...
					<li>
						<input type="reset" value="重置" id="reset" onClick="List.resetForm('queryForm')" class="reset_btn"><!-- 重置 -->
						<input type="button" value="查询"  id="query" class="search_btn mr22 " onclick="List.doSearch(gridObj);" />
					</li><!-- 查询-->
				</ul>
		   </div>
	    </form>
