    ...
    <div class="ui-table ui-widget ui-corner-all ui-border" >
		...
		<table class="table">
			<tr>
				...
				<td class="inputTd">
					<input id="edit_stuName" name="stuName" type="text" class="text" onclick="ownVipMgt();" readonly="readonly"/>
				</td>
				<td class="inputLabelTd">报名课程：</td>
				<td class="inputTd">
					<input id="edit_subjectId" name="subjectId" type="hidden" />
					<input id="edit_subjectName" name="subjectName" type="hidden" />
					<input id="edit_courseId" name="courseId" type="hidden" />
					<input id="subname" name="subname" type="text" class="text" readonly="readonly"/>
				</td>
			</tr>
			<tr>
				<td class="inputLabelTd"><span class="required">*</span>应付欠款：</td>
				<td class="inputTd">
					<input id="edit_owePay" name="owePay" type="text" class="text" readonly="readonly" />
				</td>
				<td class="inputLabelTd"><span class="required">*</span>补款金额：</td>
				<td class="inputTd">
					<input id="edit_money" name="money" type="text" class="text" onblur="countOwePay()"/>
				</td>
			</tr>
			<tr>
				<td class="inputLabelTd">欠款余额：</td>
				<td class="inputTd">
					<input id="edit_owe" name="owe" type="text" class="text" readonly="readonly"/>
				</td>
				<td class="inputLabelTd">补款时间：</td>
				<td class="inputTd">
					<div class="time_bg">
						<input type="text" class="search_time150 valid" name="time" id="edit_time" mainid="time"><!-- 时间选择控件-->
			...
			<tr>
				...
				<td class="inputTd">
					...
					<input id="edit_isCount" name="isCount" type="hidden"/>
				</td>
			</tr>
			<tr>
				<td class="inputTd" colspan="4" style="text-align:center;">
					<input id="submit" type="button" class="ti_bottom" value="保存"/>
					<input type="button" class="ti_bottom"  onclick="resetForm('continuePayFormEdit')" value="重置"/>
				</td>			
			</tr>
		</table>
				...
				<input type="hidden" id="comSource"/>
				<input type="hidden" id="comSourceName"/>
				<input type="hidden" id="sourceSubclass"/>
				<input type="hidden" id="followerId"/>
				<input type="hidden" id="followerName"/>
				<input type="hidden" id="followerType"/>
				<input type="hidden" id="followerPosition"/>
				<input type="hidden" id="followerRate"/>
				<input type="hidden" id="joinTime"/>
    </div>	
	</form>
 </div>
...
function drawForm(rowData) {
	...
	$('#followerRate').val(rowData.followerRate);
	$('#sourceSubclass').val(rowData.sourceSubclass);
	$('#comSource').val(rowData.comSource);
	$('#comSourceName').val(rowData.comSourceName);
...
function countPerformance(){
	...
	var sourceSub =$("#sourceSubclass").val();
...
// 	}
	...
	function count(folid,foltype,folrate){
		...
		var subname="";
		switch (sub) {
			case "0":subname="无";break;
			case "1":subname="未体验公开课报名";break;
			case "2":subname="体验公开课后报名";break;
			default:break;
		}
		...
		var performance = parseFloat(actualPay)*parseFloat(folrate);
