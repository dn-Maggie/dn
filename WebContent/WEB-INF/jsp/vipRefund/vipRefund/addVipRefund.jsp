...
<div id="editDialog">
    ...
    <div class="ui-table ui-widget ui-corner-all ui-border" >
    	<input id="edit_stuId" name="stuId" type="hidden" value="${vipRefund.stuId}"/>
		<input type="hidden" id="edit_id" name="id" type="text" value="${vipRefund.id}"/>
		<table class="table">
			<tr>
				<td class="inputLabelTd"><span class="required">*</span>学员姓名：</td>
				<td class="inputTd">
					<input id="edit_stuName" name="stuName" type="text" class="text" onclick="allVipMgt();" readonly/>
				</td>
				<td class="inputLabelTd"><span class="required">*</span>退款金额：</td>
				<td class="inputTd">
					<input id="edit_refund" name="refund" type="text" class="text" value="${vipRefund.refund}" onblur="isAll()"/>
				</td>
			</tr>
			<tr>
				<td class="inputLabelTd">报名学科：</td>
				<td class="inputTd">
					<input id="subname" name="subname" type="text" class="text" readonly/>
				</td>
				...
				<td class="inputTd">
					...
					<input id="coursename" name="coursename" type="text" class="text" readonly="readonly"/>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<input type="hidden" id="shouldPay"/>
    </div>
	</form>
</div>
