	...
	<div id="editDialog">
		<form id="dutyFormEdit">
			<div class="ui-table ui-widget ui-corner-all ui-border">
		        ...
		        <input id="edit_pid" name="pid" type="hidden" class="text" value="${duty.pid}"/>
				<table class="table">
					<tr>
						...
						<td class="inputTd">
							<select name="orgId" id="edit_orgId" class="select">
								<c:forEach var="orgList" items="${orgList}">
									<option value="${orgList.id}" <c:if test="${orgList.id eq duty.pid}" >selected</c:if>><c:out value="${orgList.orgName}"></c:out></option>
								</c:forEach>
							</select>
						</td>
					</tr>
