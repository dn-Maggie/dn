...
<title><m:message code="org.title" /><m:message code="title.list" /></title>
...
<body style="height:100%;">
	<div class="main  choice_box container" style="height: 100%; float: left; width:22%">
			...
			<form id="queryForm1">
				...
				<table  width="100%" border="0" cellspacing="0" cellpadding="0" class="top_table">
						<tr>
							...
							<td><input type="text" name="treeOrgName" id="treeOrgName" class="text "  onchange="initOrgTree();" /></td>
						</tr>
					</table>
				</div>
			</form>
	...
	<div class="main  choice_box">
		<div class="ui-table ui-widget ui-corner-all ui-margin ui-rightDiv" style="display: block;">
				<form id="queryForm"><!-- 查询区 表单 -->
				 	<input type="hidden" id="parentOrgId" name="parentOrgId" value="" />
					<div class="search border-bottom">
						<ul>
						<li style="width:450px;float:left;"><span>关键字:</span>
							<input id="orgNo" type="text" placeholder="机构编码" class="search_choose100" name="orgNo" autocomplete="off">
							<input id="orgName" type="text" placeholder="机构名称" class="search_choose100"  name="orgName" autocomplete="off">
							<input id="pinyin" type="text" placeholder="简拼音" class="search_choose100" name="pinyin" autocomplete="off">
						</li>
						<li class="w200"><span>机构类型:</span>
							<select name="orgType" id="orgType" class="search_choose100">
								   <option value="">--请选择--</option>
									<option value="1">公司</option>
									<option value="2">部门</option>
							</select>
						</li>
						<li class="w200"><span>机构级别:</span>	
							<select name="orgClass" id="orgClass" class="search_choose100">
										<option value="">--请选择--</option>
						...
						<li class="w200"><input type="reset" value="重置"
								onClick="List.resetForm('queryForm')" class="reset_btn"><!-- 重置 -->
								<input type="button" value="查询" onclick="List.doSearch(gridObj);"
								class="search_btn mr22 " /></li><!-- 查询-->
					</ul>
				   </div>
			    </form>
					<!--功能按钮begin-->
				<div class="list_btn_bg fl" style="z-index: 2"><!--功能按钮 div-->
					<ul>
						<c:if test="${add}">
