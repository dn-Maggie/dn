    ...
    <div class="ui-table ui-widget ui-corner-all ui-border" >
		...
		<tr>
		    <td class="inputLabelTd"><span class="required">*</span>上级机构：</td>
				<td class="inputTd">
					<input id="parentOrgName" name="parentOrgName" type="text" class="text" style="background-color: #eee; " readonly="readonly"  value="${orgParent.orgName}"/>
					<input id="parentOrgId" name="parentOrgId" type="hidden" class="text" value="${orgParent.id}"/>
				</td>
			...
			<tr>
				...
				<td colspan="3" class="inputTd">
					<input id="addr" name="addr" type="text" class="text" style="width:85.5%;" value="${org.addr}"/>
				</td>
			</tr>
			<tr>
