...
<form id="userInfoFormEdit"  >
    ...
    <div class="ui-table ui-widget ui-corner-all ui-border" >
		<table class="table">
		    <tr style="display: none;"><!-- 绕开谷歌浏览器对表单第一个password控件记住密码的规则 -->
		      <td class="inputTd">
					<INPUT id=Password  class=password value="" type=password name="PassWord"  >   
				</td>
			</tr>
			<tr>
				<td class="inputLabelTd">旧密码:</td>
				<td class="inputTd">
					<input id=eidt_Password class=password value="" type="password" name="oldPassword"/>   
				</td>
			</tr>
			<tr>
				<td class="inputLabelTd">新密码:</td>
				<td class="inputTd">
					<input id=input_password class=password value="" type="password" name="newPassWord"/>         
				</td>
			</tr>
			<tr>
				<td class="inputLabelTd">新密码确认:</td>
				<td class="inputTd">
					<input id=confirm_password class=password value="" type="password" name="confirm_password"/>
				</td>
			</tr>
			<tr>
				<tr>
