		...
		<div class="ti_box2 ">
			...
			<c:if test="${edit}">
				<a title="<m:message code="button.edit"/>" href="#" onclick="edit();" class="tool_btn">
					<span>
						<i class="back_icon edit_icon"></i>
						<em class="btn_con"><m:message code="button.edit"/></em>
					</span>
				</a>
			</c:if>
			<c:if test="${delete}">
				<a title="<m:message code="button.delete"/>" href="#" onclick="batchDelete();" class="tool_btn">
					<span>
						<i class="back_icon delete_icon"></i>
						<em class="btn_con"><m:message code="button.delete"/></em>
					</span>
				</a>
			</c:if>
				<a title="<m:message code="button.view"/>" href="#" onclick="show();" class="tool_btn">
					<span>
						...
						<em class="btn_con"><m:message code="button.view"/></em>
					</span>
				</a>
		</div>
