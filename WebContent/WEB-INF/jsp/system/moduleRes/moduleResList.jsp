...
<div class="main">
	<div class="barTitle">
        <div class="content">
			...
			<span><m:message code="moduleRes.list.title"/></span>
			<a id="displayHidden" class="displayHidden" onclick="this.blur();" href= "javascript:;"><m:message code='query.hideCondition'/></a></div>
	</div>
	...
	<div id="conditions" class="ui-table ui-widget ui-corner-all ui-margin"  style="display:block">
		<form id="moduleResForm" >
			<div class="equal"> 
				<div class="row"> 
					<div class="cell">
						<div class="labelcell"><m:message code="moduleRes.queryForm.resourceName"/>:</div>
						<div class="valuecell"><input id="resourceName" name="resourceName" type="text" class="text" value="<c:out value='${moduleRes.resourceName}'/>"/></div>
					</div>
					<div class="cell">
						<div class="labelcell"><m:message code="moduleRes.queryForm.resourcecode"/>:</div>
						<div class="valuecell"><input id="resourcecode" name="resourcecode" type="text" class="text" value="<c:out value='${moduleRes.resourcecode}'/>"/></div>
					</div>
					<div class="cell">
						<div class="labelcell"><m:message code="moduleRes.queryForm.needright"/>:</div>
						<div class="valuecell"><select id="needright" name="needright" class="select" ></select></div>
					</div>
					<div class="cell">
						<div class="labelcell"><m:message code="moduleRes.queryForm.status"/>:</div>
						<div class="valuecell"><select id="status" name="status" class="select" ></select></div>
					</div>
					<div class="querycell">
						<button id="query_button" type="button" onclick="query();"><m:message code='button.search'/></button>
						<button id="rest_button" type="button" onclick="resetForm();"><m:message code='button.reset'/></button>
                    </div>
				</div>
			</div>
		</form>
    ...
    <div class="ui-table ui-widget ui-corner-all ui-margin" >
        	   <div class="nav">
        	   		<c:if test="${sys_res_add}" var="addFlagValue">
        		   		 <button id="addBtn" onclick="add();"><m:message code='button.add'/></button>
        			</c:if>
        		   	<c:if test="${sys_res_edit}" var="editFlagValue">
        		   		<button id="editBtn" onclick="edit();"><m:message code='button.edit'/></button>
        			</c:if>
        		   	<c:if test="${sys_res_delete}" var="delFlagValue">
        		   		<button id="deleteBtn" onclick="batchDelete();"><m:message code='button.delete'/></button>
        			</c:if>
...
<div id="editDialog">
    ...
    <div class="ui-table ui-widget ui-corner-all ui-border" >
		<input type="hidden" id="edit_resuuid" name="resuuid" type="text" value="<c:out value='${moduleRes.resuuid}'/>"/>
		<table class="table">
			<tr>

				<td class="inputLabelTd"><m:message code="moduleRes.form.resourceName"/>:</td>
				<td class="inputTd">
					<input id="edit_resourceName" name="resourceName" type="text" class="text" value="<c:out value='${moduleRes.resourceName}'/>"/>
				</td>
				<td class="inputLabelTd"><m:message code="module.form.serialindex"/>:</td>
				<td class="inputTd">
					<input id="edit_serialindex" name="serialindex" type="text" class="text" value="<c:out value='${moduleRes.serialindex}'/>"/>
				</td>

			</tr>
			<tr>
				<td class="inputLabelTd"><m:message code="moduleRes.form.resourcecode"/>:</td>
				<td class="inputTd">
					<input id="edit_resourcecode" name="resourcecode" type="text" class="text" value="<c:out value='${moduleRes.resourcecode}'/>"/>
				</td>
				<td class="inputLabelTd"><m:message code="moduleRes.form.resurl"/>:</td>
				<td class="inputTd">
					<input id="edit_resurl" name="resurl" type="text" class="text" value="<c:out value='${moduleRes.resurl}'/>"/>
				</td>
			</tr>
			<tr>
				<td class="inputLabelTd"><m:message code="moduleRes.form.status"/>:</td>
				<td class="inputTd">
					<select id="edit_status" name="status" class="select" ></select>
				</td>

				<td class="inputLabelTd"><m:message code="moduleRes.form.needright"/>:</td>
				<td class="inputTd">
					<select id="edit_needright" name="needright" class="select" ></select>
				</td>

			</tr>
			<tr>
				<td class="inputLabelTd"><m:message code="moduleRes.form.memo"/>:</td>
				<td class="inputTd" colspan="3">
					<input id="edit_memo" name="memo" type="text" class="text-100" value="<c:out value='${moduleRes.memo}'/>"/>
				</td>
...
<div id="editResactDialog">
    ...
    <div class="ui-table ui-widget ui-corner-all ui-border" >
		<input type="hidden" id="edit1_actid" name="actid" type="text" value="<c:out value='${resact.actid}'/>"/>
		<input type="hidden" id="edit1_resuuid" name="resuuid" type="text" value="<c:out value='${resact.resuuid}'/>"/>
		<table class="table">
			<tr>
				<td class="inputLabelTd">资源操作名称:</td>
				<td class="inputTd" colspan="3">
					<input id="edit1_actname" name="actname" type="text" class="text" value="<c:out value='${resact.actname}'/>"/>
				</td>
			...
			<tr>
				...
				<td class="inputTd">
					<input id="edit1_actcode" name="actcode" type="text" class="text" value="<c:out value='${resact.actcode}'/>"/>
				</td>

				<td class="inputLabelTd">资源操作URL:</td>
				<td class="inputTd">
					<input id="edit1_acturl" name="acturl" type="text" class="text" value="<c:out value='${resact.acturl}'/>"/>
				</td>
			...
			<tr>
				<td class="inputLabelTd"><m:message code="moduleRes.form.status"/>:</td>
				<td class="inputTd">
					<select id="edit1_status" name="status" class="select" ></select>
				</td>

				<td class="inputLabelTd"><m:message code="moduleRes.form.needright"/>:</td>
				<td class="inputTd">
					<select id="edit1_needright" name="needright" class="select" ></select>
				</td>
			...
			<tr>
				<td class="inputLabelTd"><m:message code="moduleRes.form.memo"/>:</td>
				<td class="inputTd" colspan="3">
					<input id="edit1_remark" name="remark" type="text" class="text" value="<c:out value='${resact.remark}'/>"/>
				</td>
