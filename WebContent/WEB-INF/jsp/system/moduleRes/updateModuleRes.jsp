...
<script type="text/javascript">
	$(function() {
		...
		$("#submit").click(function() {
			...
			var options = {
				url : "<m:url value='/moduleRes/updateModuleRes.do'/>",
				type : "post",
				success : function(data) {
					var d = $.parseJSON(data);
					showMessage(d.msg?d.msg:d.message, "", "", function() {
			...
			<table class="table">
				...
				<tr>
					...
					<td class="inputTd" colspan="3"><textarea id="edit_memo"
						name="memo" class="textarea">${moduleRes.memo}</textarea></td>
				</tr>
				<tr>
