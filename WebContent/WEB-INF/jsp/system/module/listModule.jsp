...
<div class="container" id="container"><!--总div -->
		<form id="queryForm"><!-- 查询区 表单 -->
			...
			<input id="moduleName" type="text" placeholder="<m:message code="module.moduleName" />" 
			class="search_choose100"  value="" name="moduleName" autocomplete="off">
			<input id="moduleCode" type="text" placeholder="<m:message code="module.moduleCode" />" 
			class="search_choose100"  value="" name="moduleCode" autocomplete="off">
			</li>
