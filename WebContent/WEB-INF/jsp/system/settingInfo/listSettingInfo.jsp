...
<div class="container" id="container"><!--总div -->
		<form id="queryForm"><!-- 查询区 表单 -->
			...
			<input id="varNameCn" type="text" placeholder="<m:message code="settingInfo.queryForm.varNameCn" />" 
			class="search_choose100"  value="" name="varNameCn" autocomplete="off">
			<input id="variableName" type="text" placeholder="<m:message code="settingInfo.queryForm.variableName" />" 
			class="search_choose100"  value="" name="variableName" autocomplete="off">
			</li>
