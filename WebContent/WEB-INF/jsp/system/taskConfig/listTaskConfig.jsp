	...
	<div class="main  choice_box">
		<form id="queryForm"><!-- 查询区 表单 -->
			<div class="search border-bottom">
				<ul>
				<li style="width:430px;float:left;"><span>关键字:</span>
			<input id="taskName" type="text" placeholder="任务名称" 
			class="search_choose100"  value="" name="taskName" autocomplete="off">
			<input id="className" type="text" placeholder="执行类名" 
			class="search_choose100"  value="" name="className" autocomplete="off">
			<input id="classMethod" type="text" placeholder="执行方法" 
			class="search_choose100"  value="" name="classMethod" autocomplete="off">
			</li>
				 <li class="w200">
				 <span>任务状态:</span>
				 <select id="taskStatus" name="taskStatus"
							class="search_choose100">
				...
				<div class="list_btn_bg fl"><!--功能按钮 div-->
					<ul>
						...
						<li><a title="启用" href="javascript:"
							onclick="updateStatus(1);"> <i class="back_icon edit_icon"></i> <span>启用</span>
						</a></li>
						<li><a title="停用" href="javascript:"
							onclick="updateStatus(0);"> <i class="back_icon edit_icon"></i> <span>停用</span>
						</a></li>
						<li><a title="立即执行" href="javascript:"
							onclick="exe();"> <i class="back_icon resources_icon"></i> <span>立即执行</span>
						</a></li>
