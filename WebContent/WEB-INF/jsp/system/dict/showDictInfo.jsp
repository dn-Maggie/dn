...
<head>
<base href="<%=basePath%>">
<link href="<%=basePath %>styles/extends/css/pre.css" rel="stylesheet" type="text/css" />
		...
		<table class="table forview">
			...
			<tr>
			    <td colspan="4" style="text-align:center">	
					<input class="ti_bottom"  type="button" id="sub"  value="<m:message code='dict.close' />"/>
				</td>
			</tr>
		</table>
		</div>
