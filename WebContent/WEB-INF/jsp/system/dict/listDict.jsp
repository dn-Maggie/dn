...
<body style="height:100%;">
			...
			<form id="queryForm1">
				...
				<table  width="100%" border="0" cellspacing="0" cellpadding="0" class="top_table">
						<tr>
							...
							<td><input type="text" name="typeName" id="typeName" class="text " onkeyup="initDictTypeTree();" /></td>
						</tr>
					</table>
				</div>
			</form>
	...
	<div class="main  choice_box">
		<div class="ui-table ui-widget ui-corner-all ui-margin ui-rightDiv"
			...
			<input type="hidden" id="dictTypeCode" name="dictTypeCode" value=""/>
			<div class="search border-bottom">
				<ul>
				<li style="width:320px;float:left;"><span>关键字:</span>
			<input id="dictName" type="text" placeholder="<m:message code="dict.dictName" />" 
			class="search_choose100"  value="" name="dictName" autocomplete="off">
			<input id="dictCode" type="text" placeholder="<m:message code="dict.dictCode" />" 
			class="search_choose100"  value="" name="dictCode" autocomplete="off">
			</li>
				<li><input type="reset" value="重置"
						onClick="resetForm('queryForm')" class="reset_btn"><!-- 重置 -->
						<input type="button" value="查询" onclick="dictInfoSearch();"
					...
					<ul>
						<c:if test="${add}">
							<li><a title="<m:message code="button.add"/>" href="javascript:;"
								onclick="addDictInfo();"> <i class="icon_bg icon_add"> </i> <span><m:message
											code="button.add" /></span>
							</a></li>
						</c:if>
						<c:if test="${edit}">
							<li><a title="<m:message code="button.edit"/>" href="javascript:;"
								onclick="editDictInfo();"><i class="icon_bg icon_edit"></i> <span><m:message
						...
						<li><a title="<m:message code="button.view"/>" href="javascript:"
							onclick="showDictInfo();"> <i class="icon_bg icon_ckxq"></i> <span><m:message
