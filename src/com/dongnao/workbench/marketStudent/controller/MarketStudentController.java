package com.dongnao.workbench.marketStudent.controller;
...
public class MarketStudentController{
	...
	public ModelAndView toAdd(){
 		ModelAndView mv = new ModelAndView(
 				"WEB-INF/jsp/marketStudent/marketStudent/addMarketStudent");
	...
	public ModelAndView toGenZong(String key){
		...
		return new ModelAndView("WEB-INF/jsp/marketStudent/marketStudent/genZongMarketStudent","stuid",key );
	}
	/**
	 * 进入报名页面方法
	 * @param key String：实体id
	...
	public ModelAndView toList(String term){
		ModelAndView mv = new ModelAndView("WEB-INF/jsp/marketStudent/marketStudent/listMarketStudent");
	...
	public ModelAndView toListA(HttpServletRequest request){
		ModelAndView mv = new ModelAndView(
				"WEB-INF/jsp/marketStudent/marketStudent/listAMarketStudent");
	...
	public ModelAndView toAddA(){
 		ModelAndView mv = new ModelAndView(
 				"WEB-INF/jsp/marketStudent/marketStudent/addAMarketStudent");
 		Map<String,List> er = new HashMap<String, List>();
 		List<Subject> list = subjectService.listByCondition(new Subject());
 		List<Course> list2 =new ArrayList<Course>();
 		if(list!=null && list.size()>0){
