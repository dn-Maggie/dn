package com.dongnao.workbench.accountflow.controller;
...
public class AccountFlowController{
	...
	public ModelAndView toAdd(){
		return new ModelAndView("WEB-INF/jsp/accountflow/accountFlow/addAccountFlow");
	}
	...
	public ModelAndView toShow(String key){
		...
		return new ModelAndView("WEB-INF/jsp/accountflow/accountFlow/showAccountFlow","accountFlow",accountFlow );
	}
	...
	public ModelAndView toList(String term){
		...
		return new ModelAndView("WEB-INF/jsp/accountflow/accountFlow/listAccountFlow",model);
	}
	...
	public ModelAndView toEdit(String key){
		AccountFlow entity = accountFlowService.getByPrimaryKey(key);
		Map<String,String> accountFlow = FormatEntity.getObjectValue(entity);
		return  new ModelAndView("WEB-INF/jsp/accountflow/accountFlow/editAccountFlow","accountFlow",accountFlow );
	}
 	...
 	* @return ModelAndView 返回到新增页面
 	*/
 	@RequestMapping("/toAddNewAccounting")
	public ModelAndView toAddAccount(String key,HttpServletRequest request){
 		ModelAndView mv = new ModelAndView(
 				"WEB-INF/jsp/accountflow/accountFlow/addAccounting");
 		if(key!=null){
 			AccountFlow entity = accountFlowService.getByPrimaryKey(key);
 			Map<String,String> accountFlow = FormatEntity.getObjectValue(entity);
