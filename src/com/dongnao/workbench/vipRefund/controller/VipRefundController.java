package com.dongnao.workbench.vipRefund.controller;
...
import com.dongnao.workbench.vipRefund.service.VipRefundService;
...
public class VipRefundController{
	...
	public ModelAndView toAdd(){
 		ModelAndView mv = new ModelAndView(
 				"WEB-INF/jsp/vipRefund/vipRefund/addVipRefund");
	...
	public ModelAndView toShow(String key){
		...
		return new ModelAndView("WEB-INF/jsp/vipRefund/vipRefund/showVipRefund",model);
	}
	...
	public ModelAndView toList(String term){
		...
		Map<String,List> er = new HashMap<String, List>();
 		...
 		er.put("subject", list);
 		model.put("er", er);
		return new ModelAndView("WEB-INF/jsp/vipRefund/vipRefund/listVipRefund",model);
	}
	...
	public ModelAndView toSelectOwnVip(){
		return new ModelAndView("WEB-INF/jsp/vipRefund/vipRefund/selectAllVip");
	}
