package com.dongnao.workbench.continuePay.controller;
...
public class ContinuePayController{
	...
	public ModelAndView toAdd(){
 		ModelAndView mv = new ModelAndView(
 				"WEB-INF/jsp/continuePay/continuePay/addContinuePay");
	...
	public ModelAndView toShow(String key){
		...
		return new ModelAndView("WEB-INF/jsp/continuePay/continuePay/showContinuePay",model);
	}
	...
	public ModelAndView toSelectOwnVip(){
		return new ModelAndView("WEB-INF/jsp/continuePay/continuePay/selectOwnVip");
	}
