			...
			<div id="VoucherHeader" style="height: auto;">
	            <div class="headerMain" style="width: 1000px; height: 60px; line-height: 60px;">
	                <div style="margin-left: 20px; float: left;">
	                	<select class="input_select" name="documentType" id="documentType" mainid="documentType" style="width:50px" disabled="disabled">
						...
						</select>字第  <input name="documentNo" id="documentNo" type="number" class="text" style="width:40px;text-align: center;" value="${accounting.documentNo}" readonly>  号</div>
	                <div style="margin-left: 120px; float: left;"><span>制单日期&nbsp;&nbsp;</span><div class="time_bg" style="top: 15px; height: 25px;line-height: 25px;">
							<input id="billDate" type="text" class="search_time150" name="billDate" mainid="billDate" style="height: 25px;" value="${accounting.billDate}" disabled="disabled">
	                ...
	                <div id="VoucherFooter" style="margin-left: 120px; float: left;">
	                	...
	                	<select class="input_select" name="enterPno" id="enterPno" mainid="enterPno" style="width:100px" disabled="disabled">
							<c:forEach var="userInfo" items="${userInfo}">
								<option value="${userInfo.id}"<c:if test="${accounting.enterPno==userInfo.id}">selected</c:if>>${userInfo.fullName}</option>
							</c:forEach>
						</select>
					</div>	                
	                <div title="点击录入备注" id="divNote" onclick="noteBoxShow();">
	                	<span></span><textarea id="noteBox" class="noteBox" name="note" onblur="hide(this);" readonly>${accounting.note}</textarea></div>
	                <div style="float: right; margin-right: 20px;">附单据&nbsp;<input type="text" id="docAttach" name="docAttach" class="text" style="width:50px;" value="${accounting.docAttach}" readonly>&nbsp;张</div>
	            </div>
	        </div>
                ...
                <tbody>   
	                <tr class="trDetails" >
			            ...
			            <td class="tdKemu" style="width: 307px;" >
		                    <div class="InputText" style="display: block;"><textarea maxlength="45" type="text" class="inputKemu" name="accountName" readonly></textarea></div>
			            </td>
			            <td class="tdJieFang" style="width: 220px" >
			                ...
			                <div class="InputText hide" onmouseout="fillNum(this)"><input type="text" class="inputJieFang" name="mdMoney" readonly="readonly"></div>
			            </td>
			            <td class="tdLast tdDaiFang" style="width: 220px;position:relative" >
			                ...
			                <div class="InputText hide" onmouseout="fillNum(this)"><input type="text" class="inputDaiFang" name="mcMoney" readonly="readonly"></div>
	        		...
	        		<tr class="trTotal">
	                    ...
	                    <div class="TotalDisplayText DisplayMoney"><span class="totalCredit">&nbsp;</span></div>
           				 ...
           				 <div id="VoucherFooter" style="margin-left:20px;margin-top:20px">
		                	<span>审核人:</span>
		                	<select class="input_select" name="checkPno" id="checkPno" mainid="checkPno" style="width:100px" disabled="disabled">
