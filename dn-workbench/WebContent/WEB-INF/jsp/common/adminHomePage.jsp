	...
	<div class="cd-pricing-container cd-full-width cd-secondary-theme">
			...
			<li style="width:20%" >
				<ul class="cd-pricing-wrapper">
					<li data-type="monthly" class="is-visible willStu" id="MarketStudent" did="marketStudent" term="month" onclick="lookMore(this.id,this.attributes['did'].value,this.attributes['term'].value)">
					...
					<li data-type="yearly" class="is-hidden willStu" id="MarketStudent" did="marketStudent" term="year" onclick="lookMore(this.id,this.attributes['did'].value,this.attributes['term'].value)">
						<div class="cd-pricing-header topper">
							<span class="nameTop">
								<i class="iconfont">&#xe883;</i>
								<label>新增意向学员
			...
			<li style="width:20%" >
				<ul class="cd-pricing-wrapper">
					<li data-type="monthly" class="is-visible oop" id="VipStudent" did="vipStudent" term="month" onclick="lookMore(this.id,this.attributes['did'].value,this.attributes['term'].value)">
						<div class="cd-pricing-header topper">
							<span class="nameTop">
								<i class="iconfont">&#xe883;</i>
									<label>新增VIP学员
					...
					<li data-type="yearly" class="is-hidden oop" id="VipStudent" did="vipStudent" term="year" onclick="lookMore(this.id,this.attributes['did'].value,this.attributes['term'].value)">
						<div class="cd-pricing-header topper">
							<span class="nameTop">
								<i class="iconfont">&#xe883;</i>
								<label>新增VIP学员
			...
			<li class="cd-popular" style="width:20%" >
				<ul class="cd-pricing-wrapper">
					<li data-type="monthly" class="is-visible vipStu" id="VipStudent" did="vipStudent" term="month" onclick="lookMore(this.id,this.attributes['did'].value,this.attributes['term'].value)">
						<div class="cd-pricing-header topper">
							<span class="nameTop">
								<i class="iconfont">&#xe81d;</i>
								<label>新增订单
					...
					<li data-type="yearly" class="is-hidden vipStu" id="VipStudent" did="vipStudent" term="year" onclick="lookMore(this.id,this.attributes['did'].value,this.attributes['term'].value)">
						<div class="cd-pricing-header topper">
							<span class="nameTop">
								<i class="iconfont">&#xe81d;</i>
								<label>新增订单
			...
			<li style="width:40%"  >
				<ul class="cd-pricing-wrapper">
					<li data-type="monthly" class="is-visible oor" id="AccountFlow"  did="accountFlow" term="monthcost" onclick="lookMore(this.id,this.attributes['did'].value,this.attributes['term'].value)">
						<div class="cd-pricing-header topper">
							<span class="nameTop">
								<i class="iconfont">&#xe81d;</i>
								<label>消费支出
					...
					<li data-type="yearly" class="is-hidden oor" id="AccountFlow"  did="accountFlow" term="yearcost" onclick="lookMore(this.id,this.attributes['did'].value,this.attributes['term'].value)">
						<div class="cd-pricing-header topper">
							<span class="nameTop">
								<i class="iconfont">&#xe81d;</i>
								<label>消费支出
			...
			<li  class="cd-popular" style="width:40%" >
				<ul class="cd-pricing-wrapper">
					<li data-type="monthly" class="is-visible newOrder" id="VipStudent" did="vipStudent" term="monthshouldPay" onclick="lookMore(this.id,this.attributes['did'].value,this.attributes['term'].value)">
						<div class="cd-pricing-header topper">
							<span class="nameTop">
					...
					<li data-type="yearly" class="is-hidden newOrder" id="VipStudent" did="vipStudent" term="yearshouldPay" onclick="lookMore(this.id,this.attributes['did'].value,this.attributes['term'].value)">
						<div class="cd-pricing-header topper">
							<span class="nameTop">
								<i class="iconfont">&#xf0191;</i>
								<label>应收总额
			...
			<li style="width:30%" >
				<ul class="cd-pricing-wrapper">
					<li data-type="monthly" class="is-visible allCost" id="AccountFlow"  did="accountFlow" term="monthxftk" onclick="lookMore(this.id,this.attributes['did'].value,this.attributes['term'].value)">
						<div class="cd-pricing-header topper">
							<span class="nameTop">
								<i class="iconfont">&#xe7de;</i>
								<label>退款总额
					...
					<li data-type="yearly" class="is-hidden allCost" id="AccountFlow"  did="accountFlow" term="yearxftk" onclick="lookMore(this.id,this.attributes['did'].value,this.attributes['term'].value)"> 
						<div class="cd-pricing-header topper">
							<span class="nameTop">
								<i class="iconfont">&#xe7de;</i>
								<label>退款总额
			...
			<li  class="cd-popular" style="width:30%">
				<ul class="cd-pricing-wrapper">
					<li data-type="monthly" class="is-visible vipStu"   did="vipStudent" id="VipStudent" term="monthowePay" onclick="lookMore(this.id,this.attributes['did'].value,this.attributes['term'].value)">
						<div class="cd-pricing-header topper">
							<span class="nameTop">
								<i class="iconfont">&#xe765;</i>
								<label>应收欠款
					...
					<li data-type="yearly" class="is-hidden vipStu"   did="vipStudent" id="VipStudent"  term="yearowePay" onclick="lookMore(this.id,this.attributes['did'].value,this.attributes['term'].value)">
						<div class="cd-pricing-header topper">
							<span class="nameTop">
								<i class="iconfont">&#xe765;</i>
								<label>应收欠款
				...
				<ul class="cd-pricing-wrapper">
					...
					<li data-type="yearly" class="is-hidden allCost"  did="accountFlow" id="AccountFlow" term="majorIncome" onclick="lookMore(this.id,this.attributes['did'].value,this.attributes['term'].value)">
						<div class="cd-pricing-header topper">
							...
							<div class="cd-price">
								<span class="cd-value-big">
									<fmt:formatNumber value="${model.currYear.actualPay}" pattern="0" type="number"></fmt:formatNumber>								
								</span>
							</div>
							<c:if test="${model.currYear.actualPay - model.beforeYear.actualPay>=0&&model.beforeYear.actualPay>0}">
								<div class="stat stat-success">
									<fmt:formatNumber value="${(model.currYear.actualPay - model.beforeYear.actualPay)/model.beforeYear.actualPay}" type="percent"></fmt:formatNumber>
								</div>
							</c:if>
							<c:if test="${model.currYear.actualPay - model.beforeYear.actualPay<0&&model.beforeYear.actualPay>0}">
								<div class="stat stat-important">
									<fmt:formatNumber value="${(model.beforeYear.actualPay - model.currYear.actualPay)/model.beforeYear.actualPay}" type="percent"></fmt:formatNumber>
								</div>
							</c:if>
						</div> <!-- .cd-pricing-header -->
					</li>
			...
			<li  style="width:33.3%" >
				<ul class="cd-pricing-wrapper">
					<li data-type="monthly" class="is-visible oop"  id="AccountFlow" did="accountFlow" term="monthactualPay" onclick="lookMore(this.id,this.attributes['did'].value,this.attributes['term'].value)">
						<div class="cd-pricing-header topper">
							<span class="nameTop">
								<i class="iconfont">&#xe6a9;</i>
								<label>实收报名费
					...
					<li data-type="yearly" class="is-hidden oop"  id="AccountFlow" did="accountFlow"  term="yearactualPay" onclick="lookMore(this.id,this.attributes['did'].value,this.attributes['term'].value)">
						<div class="cd-pricing-header topper">
							<span class="nameTop">
								<i class="iconfont">&#xe6a9;</i>
								<label>实收报名费
			...
			<li  class="cd-popular" style="width:33.3%" >
				<ul class="cd-pricing-wrapper">
					<li data-type="monthly" class="is-visible complain"  did="continuePay" id="ContinuePay" term="month" onclick="lookMore(this.id,this.attributes['did'].value,this.attributes['term'].value)">
						<div class="cd-pricing-header topper">
							<span class="nameTop">
								<i class="iconfont">&#xe6cc;</i>
								<label>实收补款
					...
					<li data-type="yearly" class="is-hidden complain"  did="continuePay" id="ContinuePay" term="year" onclick="lookMore(this.id,this.attributes['did'].value,this.attributes['term'].value)">
						<div class="cd-pricing-header topper">
							<span class="nameTop">
								<i class="iconfont">&#xe81d;</i>
								<label>实收补款
	...
	<div class="cd-center-container">
		<div class="center-title">
			<span class="nameCenter">
				<i class="iconfont-xsmall">&#xe7c6; </i>总报表
			</span>
		</div>
		<ul class="cd-popular cd-center">
					<li data-type="monthly" class="is-visible"  did="vipStudent" id="VipStudent" term="vipCnt" onclick="lookMore(this.id,this.attributes['did'].value,this.attributes['term'].value)">
						<div class="cd-pricing-header center">
							...
							<div class="cd-price">
								<span class="cd-value-small" title="报名学员总数">
									<fmt:formatNumber value="${model.all.vipcnt}" pattern="0" type="number"></fmt:formatNumber>
								</span>
							</div>
						</div> <!-- .cd-pricing-header center -->
					</li>
					<li data-type="monthly" class="is-visible" did="vipStudent" id="VipStudent" term="orderCnt" onclick="lookMore(this.id,this.attributes['did'].value,this.attributes['term'].value)">
						<div class="cd-pricing-header center">
							<span class="nameCenter">
								<i class="iconfont-small">&#xe7c6;</i>
								<label>订单量</label>
					...
					<li data-type="monthly" class="is-visible" did="accountFlow" id="AccountFlow" term="majorIncome" onclick="lookMore(this.id,this.attributes['did'].value,this.attributes['term'].value)">
						<div class="cd-pricing-header center">
							<span class="nameCenter">
								<i class="iconfont-small">&#xe623;</i>
								<label>主营业务收入
					...
					<li data-type="monthly" class="is-visible" did="accountFlow" id="AccountFlow" term="QTSR" onclick="lookMore(this.id,this.attributes['did'].value,this.attributes['term'].value)">
						<div class="cd-pricing-header center">
							<span class="nameCenter">
								<i class="iconfont-small">&#xe623;</i>
								<label>其他业务收入
								<i class="info-iconfont" title="本年其他收入总额">&#xe637;</i>
								</label>
							</span>
							<div class="cd-price">
							<span class="cd-value-small">
								<fmt:formatNumber value="${model.allxf.qtsr}" pattern="0" type="number"></fmt:formatNumber>
							</span>
							</div>
						</div>
					</li>
					
					<li data-type="monthly" class="is-visible" did="accountFlow" id="AccountFlow"  term="majorCost" onclick="lookMore(this.id,this.attributes['did'].value,this.attributes['term'].value)">
						<div class="cd-pricing-header center">
							<span class="nameCenter">
								<i class="iconfont-small">&#xe7de;</i>
								<label>主营业务成本
								<i class="info-iconfont" title="总成本-学费退款-其他业务支出">&#xe637;</i>
								</label>
							</span>
							<div class="cd-price">
								<span class="cd-value-small">
									<fmt:formatNumber value="${model.allMoney.loan-model.allxf.xftk-model.allxf.qtzc}" pattern="0" type="number"></fmt:formatNumber>
								</span>
							</div>
						</div> <!-- .cd-pricing-header center -->
					</li>
					<li data-type="monthly" class="is-visible" did="accountFlow" id="AccountFlow" term="QT" onclick="lookMore(this.id,this.attributes['did'].value,this.attributes['term'].value)">
						<div class="cd-pricing-header center">
							<span class="nameCenter">
								<i class="iconfont-small">&#xe7de;</i>
								<label>其他业务支出</label>
							...
							<div class="cd-price">
								<span class="cd-value-small">
									<fmt:formatNumber value="${model.allxf.qtzc}" pattern="0" type="number"></fmt:formatNumber>
								</span>
							</div>
						</div> <!-- .cd-pricing-header center -->
					</li>
					
					<li data-type="monthly" class="is-visible" did="accountFlow" id="AccountFlow" term="allCost" onclick="lookMore(this.id,this.attributes['did'].value,this.attributes['term'].value)">
						<div class="cd-pricing-header center">
							<span class="nameCenter">
								<i class="iconfont-small">&#xe7de;</i>
								<label>总收入
								<i class="info-iconfont" title="主营业务收入+其他业务收入">&#xe637;</i>
								</label>
							</span>
							<div class="cd-price">
								<span class="cd-value-small">
									<fmt:formatNumber value="${model.all.actualPay+model.allxf.qtsr}" pattern="0" type="number"></fmt:formatNumber>
								</span>
							</div>
						</div> <!-- .cd-pricing-header center -->
					</li>
					<li data-type="monthly" class="is-visible" did="accountFlow" id="AccountFlow" term="allCost" onclick="lookMore(this.id,this.attributes['did'].value,this.attributes['term'].value)">
						<div class="cd-pricing-header center">
							<span class="nameCenter">
								<i class="iconfont-small">&#xe7de;</i>
								<label>总成本
								<i class="info-iconfont" title="主营业务成本+其他业务支出">&#xe637;</i>
								</label>
							</span>
							<div class="cd-price">
								<span class="cd-value-small">
									<fmt:formatNumber value="${model.allMoney.loan-model.allxf.xftk-model.allxf.xftj}" pattern="0" type="number"></fmt:formatNumber>
								</span>
							</div>
						</div> <!-- .cd-pricing-header center -->
					</li>
					<li data-type="monthly" class="is-visible" did="accountFlow" id="AccountFlow" term="allProfit" onclick="lookMore(this.id,this.attributes['did'].value,this.attributes['term'].value)">
						<div class="cd-pricing-header center">
							<span class="nameCenter">
								<i class="iconfont-small">&#xf01c9;</i>
								<label>总利润
								<i class="info-iconfont" title="总收入-总成本">&#xe637;</i>
								</label>
							</span>
							<div class="cd-price">
								<span class="cd-value-small" id="profit">
									<fmt:formatNumber value="${model.all.actualPay+model.allxf.qtsr-model.allMoney.loan+model.allxf.xftk+model.allxf.xftj}" pattern="0" type="number"></fmt:formatNumber>
								</span>
							</div>
						</div>
					</li>
