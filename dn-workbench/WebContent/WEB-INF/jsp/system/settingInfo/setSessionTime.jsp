...
<div class="ui-table ui-widget ui-corner-all ui-border">
	<table class="table" >
		<tr>
			<td class="inputLabelTd"><m:message code="sessionInfo.queryForm.lostTime" />:</td>
			<td class="inputTd">
				<input id="lostTime" name="lostTime" type="text" class="text" value="${sessionValue}" />				
			</td>
		</tr>
		<tr>
			<td class="inputLabelTd"><m:message code="sessionInfo.queryForm.memo" />:</td>
			<td class="inputTd">
		...
		<tr>
			<td class="inputTd" colspan="2" style="text-align:center;">
				<input id="submit" type="button" class="ti_bottom" onclick="update();" value="<m:message code='button.save' />"/>
				<input id="return" type="button" class="ti_bottom" onclick="closeView();" value="<m:message code='button.close' />"/>
			</td>
		</tr>
	</table>
</div>
