...
<div id="editDialog">
    ...
    <div class="ui-table ui-widget ui-corner-all ui-border" >
		<input type="hidden" id="edit_id" name="id" type="text" value="${personrole.id}"/>
		<table class="table">
			<tr>
				<td class="inputLabelTd"><m:message code="personrole.roleId"/>:</td>
				<td class="inputTd">
					<input id="edit_roleId" name="roleId" type="text" class="text" value="${personrole.roleId}"/>
				</td>
				<td class="inputLabelTd"><m:message code="personrole.createTime"/>:</td>
				<td class="inputTd">
					<input id="edit_createTime" name="createTime" type="text" class="text" value="${personrole.createTime}"/>
				</td>
			</tr>
			<tr>
				<td class="inputLabelTd"><m:message code="personrole.userId"/>:</td>
				<td class="inputTd" colspan="3">
					<input id="edit_userId" name="userId" type="text" class="text" value="${personrole.userId}"/>
				</td>
			</tr>
			<tr>
