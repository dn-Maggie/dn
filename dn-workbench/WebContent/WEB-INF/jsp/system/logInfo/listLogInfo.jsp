			...
			<div class="search border-bottom">
				<ul>
					<li style="width: 310px; float: left;"><span>关键字:</span> <input
							id="actorName" type="text" placeholder="<m:message code="logInfo.queryForm.actorName"/>"
							class="search_choose100" value="" name="actorName"
							autocomplete="off">
							 <input
							id="actResult" type="text" placeholder="<m:message code="logInfo.queryForm.actResult" />"
				...
				<li class="date_area">
					<span>操作时间:</span>
					<div class="time_bg">
						<input type="text"  name="actTime" class="search_time150" id="actTime">
						<i class="search_time_ico2"></i>
					</div>
					<i>至</i>
					<div class="time_bg">
						<input type="text"  name="endTime" class="search_time150" id="endTime">
						<i class="search_time_ico2"></i>
					</div></li>
				 <li><span><m:message code="logInfo.queryForm.actType" />:</span><select id="actType" name="actType" class="search_select" ></select>
				</li><!--下拉 -->		
				...
				<div class="list_btn_bg fl"><!--功能按钮 div-->
					<ul>
						...
						<li><a title="<m:message code="button.view"/>" href="javascript:;"
							onclick="view();"> <i class="icon_bg icon_ckxq"></i> <span><m:message
