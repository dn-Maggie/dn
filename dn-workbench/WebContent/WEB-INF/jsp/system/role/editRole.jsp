...
<body>
    ...
    <input type="hidden" id="edit_roleId" name="roleId" type="text" value="${role.roleId}"/>
		<table class="table">
			<tr>
				<td class="inputLabelTd"><span class="required">*</span><m:message code="role.roleName"/>:</td>
				<td class="inputTd">
					<input id="edit_roleName" name="roleName" type="text" class="text" value="${role.roleName}"/>
				</td>
				<td class="inputLabelTd"><span class="required">*</span><m:message code="role.roleCode"/>:</td>
				<td class="inputTd">
					<input id="edit_roleCode" name="roleCode" type="text" class="text" value="${role.roleCode}"/>
				</td>
			</tr>
<%-- 			<tr>
			...
			<tr>
				...
				<td class="inputTd">
					<input id="edit_roleDesc" name="roleDesc" type="text" class="text" value="${role.roleDesc}"/>
				</td>
			...
			<tr>
				...
				<td class="inputTd" colspan="3">
					<textarea rows="5" cols="120" name="memo" id="edit_memo" class="common_txtarea" maxlength ="200"><c:out value="${role.memo}" /></textarea>
				</td>
			</tr>
			<tr>
