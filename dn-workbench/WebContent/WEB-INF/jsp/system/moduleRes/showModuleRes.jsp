...
<body>
	<div class="ui-table ui-widget ui-corner-all ui-border">
		<table class="table forview">
			<tr>
				<td class="inputLabelTd"><m:message code="moduleRes.resourceName"/>:</td>
				<td class="inputTd"><c:out value='${moduleRes.resourceName}'/></td>
				<td class="inputLabelTd"><m:message code="moduleRes.serialindex"/>:</td>
				<td class="inputTd"><c:out value='${moduleRes.serialindex}'/></td>
			</tr>
			<tr>
				<td class="inputLabelTd"><m:message code="moduleRes.resourcecode"/>:</td>
			...
			<tr>
				...
				<td class="inputTd" colspan="3"><c:out value='${moduleRes.memo}'/></td>
			</tr>
			<tr>
