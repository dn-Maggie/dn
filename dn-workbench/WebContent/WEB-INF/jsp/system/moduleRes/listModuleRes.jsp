	...
	<div class="container" id="container">
		...
		<form id="queryForm">
			...
			class="search_choose100"  value="" name="resourcecode" autocomplete="off">
					...
					<li><select id="status" name="status" class="search_select"></select> <span><m:message code="moduleRes.status" />:</span></li>
					<!--下拉 -->

					<li><select id="needright" name="needright" class="search_select"></select> <span><m:message code="moduleRes.needright" />:</span></li>
					<!--下拉 -->
