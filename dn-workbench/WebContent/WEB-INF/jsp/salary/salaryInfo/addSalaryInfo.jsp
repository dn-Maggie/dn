...
$(function() {	
	...
	$("#submit").click(function() {
		...
		var options = {
			url : "<m:url value='/salaryInfo/addSalaryInfo.do'/>",
			type : "post",
				dataType:"json",
				success : function(d) {
					if(d.status){
...
function changeSalaryInfo(textbox, type) {
	...
	if (!isNaN(value)) {
		...
		if (type == 2) {// 减款项
			...
			$("#factSalary").val((duesSalary + chargetotal).toFixed(2)); // 更新实发工资结果
		}
	} else {
...
<div id="editDialog">
    ...
    <div class="ui-table ui-widget ui-corner-all ui-border" >
		...
		<table class="table">
			<tr>
				<td class="inputLabelTd"><span class="required">*</span>人员姓名：</td>
				<td class="inputTd">
				<div style="width:130px;">
					<input id="userName" name="userName"  readonly="readonly"  type="text" class="text" style="width:80px;" value="${salaryInfo.username}"/>
					<input type="hidden" id="userId" name="userId" type="text"/>
					<a href="javascript:window.parent.selectUserWinOpen(window);" class="icon_second-level sicon_userInfo" title="选择人员" style="margin-top: 5px;float: right;margin-right: 20px;"></a>
					</div>
				</td>
				<td class="inputLabelTd">所在部门：</td>
				<td class="inputTd">
					<input id="orgName" name="orgName" type="text" class="border_none" value="${salaryInfo.orgName}"/>
					<input type="hidden" id="orgId" name="orgId" type="text" />
				</td>
				<td class="inputLabelTd">薪酬标准：</td>
				<td class="inputTd">
					<input id="standName" name="standName" type="text" class="border_none" value="${salaryInfo.standName}"/>
					<input type="hidden" id="standId" name="standId" type="text" />
				</td>
			</tr>
				<tr>
				...
				<td class="inputTd">
				<div class="time_bg">
						<input id="ym" type="text" class="search_time150" style="width:80px;" name="ym" value="${ym}">
						<i class="search_time_ico2"></i>
					</div>
				</td>
				<td class="inputLabelTd">核定工资：</td>
				<td class="inputTd">
					<input id="approvedSalary" name="approvedSalary" class="border_none salary_input_w_def currency_red_16" readonly="readonly" value="0.0"  type="text"  value="${salaryInfo.approvedSalary}"/>
				</td>
				<td class="inputLabelTd">应付工资：</td>
				<td class="inputTd">
					<input id="duesSalary" name="duesSalary" class="border_none salary_input_w_def" readonly="readonly" value="0.0"  type="text"  value="${salaryInfo.duesSalary}"/>
				</td>
			</tr>
			<tr>
			<td class="inputLabelTd">工资类型:</td>
				<td class="inputTd">
				<input id="salaryTypeName" name="salaryTypeName"  readonly="readonly"  
				type="text" class="border_none salary_input_w_def" />
					<input type="hidden" id="salaryTypeCode" name="salaryTypeCode" type="text"/>
				</td>
				<td class="inputLabelTd">扣款：</td>
				<td class="inputTd">
					<input id="deduct" name="deduct" class="border_none salary_input_w_def" readonly="readonly" value="0.0"  type="text"  value="${salaryInfo.deduct}"/>
				</td>
				<td class="inputLabelTd">实发工资：</td>
				<td class="inputTd">
					<input id="factSalary" name="factSalary" class="border_none salary_input_w_def currency_red_16" readonly="readonly" value="0.0"  type="text"  value="${salaryInfo.factSalary}"/>
				</td>
			...
			<tr>
				...
				<textarea rows="1" id="remark" name="remark" class="text" style="width: 580px;height:45px;"></textarea>
				</td>
			...
			<tr>
				...
				<td class="inputTd">
					<input id="basicSalary"  name="basicSalary" class="border_none salary_input_w_def" readonly="readonly" value="0.0"  type="text"    value="${salaryInfo.basicSalary}"/>
				</td>
				<td class="inputLabelTd">岗位工资：</td>
				<td class="inputTd">
					<input id="dutySalary" name="dutySalary" class="border_none salary_input_w_def" readonly="readonly" value="0.0"  type="text"value="${salaryInfo.dutySalary}"/>
				</td>
			...
			<tr>
				...
				<td class="inputTd">
					<input id="socialSecuritySalary" name="socialSecuritySalary" class="border_none salary_input_w_def" readonly="readonly" value="0.0"  type="text" value="${salaryInfo.socialSecuritySalary}"/>
				</td>
				<td class="inputLabelTd">绩效工资：</td>
				<td class="inputTd">
					<input id="performanceSalary" name="performanceSalary" class="border_none salary_input_w_def" readonly="readonly" value="0.0"  type="text" value="${salaryInfo.performanceSalary}"/>
				</td>
			...
			<tr>
				...
				<td class="inputTd">
					<input id="ageSalary" name="ageSalary" class="border_none salary_input_w_def" readonly="readonly" value="0.0"  type="text" value="${salaryInfo.ageSalary}"/>
				</td>
				<td class="inputLabelTd">文凭工资：</td>
				<td class="inputTd">
					<input id="diplomaSalary" name="diplomaSalary" class="border_none salary_input_w_def" readonly="readonly" value="0.0"  type="text" value="${salaryInfo.diplomaSalary}"/>
				</td>
			...
			<tr>
				...
				<td class="inputTd">
					<input id="reward" name="reward" type="text" class="border_none salary_input_w_def" readonly="readonly" value="0.0"/>
				</td>
			</tr>
			<tr>
				...
				<td class="inputTd">
					<input id="punish" name="punish" type="text" class="border_none salary_input_w_def" readonly="readonly" value="0.0" />
				</td>
				<td class="inputLabelTd">其它：</td>
				<td class="inputTd">
					<input id="other" name="other" type="text" class="text salary_input_w_def" 
					onkeyup="checkNegativeNumber(this);changeSalaryInfo(this,1);this.oldvalue = this.value" 
				onkeydown="this.oldvalue = this.value;" 
				onkeypress="return forbidBackSpace(event);" 
				onfocus="clanInpit(this);" 
				onblur="byeInput(this);" 
			...
			<tr>
				<td class="inputTd" colspan="6" style="text-align:center;">
					...
					<input id="close_btn" onClick="window.parent.closeAdd();" type="button" class="ti_bottom" value="取消"/>
				</td>
			</tr>
		</table>
    </div>
