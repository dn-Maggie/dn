		    ...
		    <div class="wrap">
				...
				<div class="top_head">
					...
					<div class="time_bg" style="top:40px; right:0px;height: 25px;line-height: 25px;position:absolute;width:200px">
						<span>申请日期：</span>
						<input id="edit_createDate" name="createDate" style="height:25px;width:100px" class="input_select" readonly/>
					...
					<table class="table">
						<tr>
							...
							<td class="inputTd">
								...
								<input id="edit_empId" name="empId" type="hidden" value="${user.id}" readonly/>
							</td>
						</tr>
						...
						<tr class="trDetails" style="height:140px;">
							...
							<td class="inputTd" colspan="3">
								<textarea  class="text" name="content" id="edit_content"></textarea>
							</td>	       
						</tr>
						<tr>
							...
							<td class="inputTd">
								<div class="time_bg" style="width: 98%;">
									<input type="text" class="search_time150 valid text" name="startDate" id="edit_startDate" mainid="startDate" style="width: 88%;" onblur="countLeaveDays()"><!-- 时间选择控件-->
							...
							<td class="inputTd">
								<div class="time_bg" style="width: 98%;">
									<input type="text" class="search_time150 valid text" name="endDate" id="edit_endDate" mainid="endDate" style="width: 88%;" onblur="countLeaveDays()"><!-- 时间选择控件-->
									<i class="search_time_ico2"></i>
								</div>
							</td>
						</tr>
						<tr>
							...
							<td class="inputTd" >
								<input id="edit_straightLeaderName" name="straightLeaderName" type="text" class="text" list="employeeList" onchange="getEmpIDByName(this,this.value);"/>
								<datalist id="employeeList">
									<c:forEach var="emp" items="${emp}">
										<option did="${emp.id}" value="${emp.nickName}" label="${emp.name}"></option>
						             </c:forEach>
								</datalist>
								<input id="edit_straightLeader" name="straightLeader" type="hidden"/>
							</td>
						</tr>
					</table>
