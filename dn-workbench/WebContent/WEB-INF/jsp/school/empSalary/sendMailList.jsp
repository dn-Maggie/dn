	...
	<body style="background: #fff;height:100%;position: absolute;width: 100%" >
			<div class="page-header">
				<h1 style="text-align: right;cursor: default;">
					...
					<input type="button" class="btn btn-success" id="sendBtn" value="全部发送">
					<input type="button" class="btn btn-default" id="cancelBtn" value="全部暂停">
				</h1>
			</div>
			<div class="col-xs-12" style="height:70%;overflow-y: scroll;overflow-x: hidden;">
			...
			<div class="col-xs-12" id="errorMsg" style="border-top:1px dotted #e2e2e2;height: 20%;overflow-y: scroll;overflow-x: hidden;">
			</div>
