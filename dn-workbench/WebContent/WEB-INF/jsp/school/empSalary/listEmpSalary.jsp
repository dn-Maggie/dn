		...
		/* var lastsel; */
  		gridObj = new biz.grid({
            ...
            colModel:[
				...
				{name : "empBankCard",label:"银行卡号",index : "empBankCard", editable:true ,width:"12"},
				...
				{name : "empBeFullDate",label:"转正日期",width:"6",index : "empBeFullDate"}, 
		...
		<div class="listplace">
				...
				<div class="list_btn_bg fl"><!--功能按钮 div-->
					<ul>
						...
						<li>
							<a title="审核" href="javascript:" onclick="audit();"> 
