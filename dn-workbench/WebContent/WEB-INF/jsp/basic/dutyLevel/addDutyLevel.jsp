...
<div id="editDialog">
    ...
    <div class="ui-table ui-widget ui-corner-all ui-border" >
		<input type="hidden" id="edit_id" name="id" type="text" value="${dutyLevel.id}"/>
		<table class="table">
			<tr>
				<td class="inputLabelTd">岗位名称：</td>
				<td class="inputTd">
					<select class="input_select" id="edit_dutyId" name="dutyId">
						<c:forEach var="dutys" items="${dutys}">
							<option value="${dutys.id}" <c:if test="${dutys.id==duty.id}">selected</c:if>><c:out value="${dutys.dutyName}"></c:out></option>
						</c:forEach>
					</select>
				</td>
				<td class="inputLabelTd">等级类型：</td>
				<td class="inputTd">
					<input id="edit_levelType" name="levelType" type="text" class="text" list="levelTypeList"/>
			...
			<tr>
				...
				<td class="inputTd">
					<input id="edit_levelName" name="levelName" type="number" min="0" class="text" value="${dutyLevel.levelName}"/>
				</td>
				<td class="inputLabelTd">薪级工资：</td>
				<td class="inputTd">
					<input id="edit_levelSal" name="levelSal" type="number" min="0" class="text" value="${dutyLevel.levelSal}"/>
				</td>
			</tr>
			<tr>
