		...
		<div class="ui-table ui-widget ui-corner-all ui-border">
			<table class="table">
				<tr>
					...
					<td class="inputTd">
						<input id="edit_fullName" name="fullName" type="text" class="text" value="${userInfo.fullName}" />
						<input id="edit_orgName" name="orgName" type="hidden" class="text" value="服务部门"/>
						<input id="edit_orgId" name="orgId" type="hidden" class="text"	value="4" />
						<input id="orgClass" name="orgClass" type="hidden" class="text" value="1" />
						<input id="dutyName" name="dutyName" type="hidden" class="text" value="兼职班主任" /> 
				...
				<tr>
					...
					<td class="inputTd">
					<input id="edit_roleName" name="roleName" type="text" class="text" value="兼职班主任" readonly/>
					<input id="edit_roleId" name="roleId" type="hidden" class="text" value="f6961666-7b81-423a-941b-c85cb7312513" />
...
<!-- 					</select></td> -->
				...
				<tr>
					<td class="inputTd" colspan="5" style="text-align: center;">
						...
						<input id="button" type="button" class="ti_bottom" value="重置" onclick="resetForm('userInfoFormAdd')"/>
					</td>
				</tr>
			</table>
		</div>
