			...
			<form id="queryForm1">
				...
				<table  width="100%" border="0" cellspacing="0" cellpadding="0" class="top_table">
						<tr>
							...
							class="text" style="width:100px;" onkeyup="search_ztree('orgTree','name',this);" /></td>
		...
		<!-- 查询区 表单 -->
			...
			class="search_choose100"  value="" name="idCard" autocomplete="off">
				...
				<input type="reset" value="确定"
						onClick="doSelect()" class="reset_btn">
				<input type="reset" value="重置"
						onClick="resetForm('queryForm')" class="reset_btn mr22"><!-- 重置 -->
