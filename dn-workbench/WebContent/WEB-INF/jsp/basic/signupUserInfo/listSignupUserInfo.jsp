...
<body style="height:100%;">
	...
	<div class="main  choice_box">
		...
		<!-- 查询区 表单 -->
				...
				<ul>
				<li style="width:560px;float:left;"><span>关键字:</span>
			<input id="userAccount" type="text" placeholder="帐号" 
			...
			<li style="width:500px;"><span>所属地区:</span>
		<input id="areaProvinceName"
						name="areaProvinceName" type="text" placeholder="省"  class="search_choose100"
						value="" /> <input
						id="areaProvinceId" name="areaProvinceId" type="hidden"
						class="text" value="" /> <input
						id="areaRegionName" name="areaRegionName" type="text" placeholder="市"  class="search_choose100"
						value="" /> <input id="areaRegionId"
						name="areaRegionId" type="hidden" class="text"
						value="" /> <input id="areaCityName"
						name="areaCityName" type="text"  placeholder="区县" class="search_choose100"
						value="" /> <input id="areaCityId"
