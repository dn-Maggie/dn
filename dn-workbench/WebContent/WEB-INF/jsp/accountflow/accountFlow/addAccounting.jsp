...
function updateAccountFlow(){
	var paramDatas = {
			isAccount:'2',id:$("#edit_id").val()
			}
	$.ajax({
		   type: "post",
...
<div id="editDialog">
	...
	<div id="divBody" style="min-height: 400px;" >
		...
		<input type="hidden" id="isAccount" name="isAccount" type="text" value="${accountFlow.isAccount}"/>
