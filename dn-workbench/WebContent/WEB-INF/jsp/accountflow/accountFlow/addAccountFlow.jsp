    ...
    <div class="ui-table ui-widget ui-corner-all ui-border" >
		...
		<table class="table">
			<tr>
				...
				<td class="inputTd">
					<input id="edit_accountId" name="accountId" type="hidden" class="text" value="${accountFlow.accountId}"/>
					<input id="edit_accountNo" name="accountNo" type="text" class="text" value="${accountFlow.accountNo}"/>
				</td>
				<td class="inputLabelTd">科目类型：</td>
				<td class="inputTd">
					<select class="input_select" id="groupFinanceType" name="accountType" style="float:none">
			...
			<tr>
				...
				<td class="inputTd">
					<div class="time_bg">
						<input type="text" class="search_time150" name="createDate" id="edit_createDate" mainid="createDate"><!-- 时间选择控件-->
			...
			<tr>
				...
				<td class="inputTd">
					<input id="edit_money" name="money" type="number" class="text" value="${accountFlow.money}"/>
				</td>
