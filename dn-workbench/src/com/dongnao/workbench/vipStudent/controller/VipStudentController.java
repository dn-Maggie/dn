...
public class VipStudentController {
	...
	public ModelAndView toAdd() {
		ModelAndView mv = new ModelAndView(
				"WEB-INF/jsp/vipStudent/vipStudent/addVipStudent");
	...
	public ModelAndView toShow(String key) {
		...
		return new ModelAndView("WEB-INF/jsp/vipStudent/vipStudent/showVipStudent", "vipStudent", vipStudent);
	}
...
//		AjaxUtils.sendAjaxForObjectStr(response,vipStudentService.add(vipStudent));
	...
	public ModelAndView toEdit(String key) {
		ModelAndView mv = new ModelAndView(
				"WEB-INF/jsp/vipStudent/vipStudent/editVipStudent");
		VipStudent entity = vipStudentService.getByPrimaryKey(key);
		Map<String, String> vipStudent = FormatEntity.getObjectValue(entity);
	...
	public ModelAndView toManagePerformance(String key){
		ModelAndView mv = new ModelAndView(
				"WEB-INF/jsp/vipStudent/vipStudent/managePerformance");
