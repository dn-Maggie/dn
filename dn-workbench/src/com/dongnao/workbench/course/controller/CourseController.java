package com.dongnao.workbench.course.controller;
...
public class CourseController {
	...
	public ModelAndView toAdd() {
		ModelAndView m=new ModelAndView("WEB-INF/jsp/course/course/addCourse");
	...
	public ModelAndView toShow(String key) {
		...
		ModelAndView m=new ModelAndView("WEB-INF/jsp/course/course/showCourse", "course", course);
		Subject s=new Subject();
		List<Subject> subList=subjectService.listByCondition(s);
 		m.addObject("subList",subList);
		return m;
	...
	public ModelAndView toList() {
		ModelAndView m=new ModelAndView("WEB-INF/jsp/course/course/listCourse");
		Subject s=new Subject();
		List<Subject> subList=subjectService.listByCondition(s);
		Course c=new Course();
...
//		}
	...
	public ModelAndView toEdit(String key) {
		Course entity = courseService.getByPrimaryKey(key);
		Map<String, String> course = FormatEntity.getObjectValue(entity);
		ModelAndView m=new ModelAndView("WEB-INF/jsp/course/course/editCourse", "course", course);
		Subject s=new Subject();
		List<Subject> subList=subjectService.listByCondition(s);
 		m.addObject("subList",subList);
		return m;
